...
public class SauceLabsTest implements SauceOnDemandSessionIdProvider {
	...
	public static final String USERNAME = System.getenv().get("SAUCE_USERNAME");
	public static final String ACCESS_KEY = System.getenv().get("SAUCE_ACCESS_KEY");
     ...
     * @param browser
     */
    public SauceLabsTest(String os, String version, String browser) {
        super();
        this.os = os;
